 ...
 */
(function (b) { var a = b.fn.wowSlider; b.fn.wowSlider = function (p) { var N = p.autoPlay; var e = b(".ws_images ul")[0].children; var I = e.length; var L = null; var m; var F = true; if (this.hasClass("delays")) {
    p.autoPlay = false;
    var l = new Array();
    for (var K = 0; K < I; K++) {
        l[K] = b(e[K]).data("delay") || p.delay;
    }
    function v() { clearTimeout(L); L = setTimeout(function () { if (N && m && !F) {
        m[0].wsStart();
    }
    else {
        F = false;
    ...
    v();
} var t = p.onBeforeStep; var k = p.onStep; b.extend(p, { onBeforeStep: function (O, P) { if (!N && m) {
        m[0].wsStop();
        return O;
    }
    else {
    ...
    } } }); m = a.apply(this, [p]); var B = p.startSlide || 0; var j = this; var s = p.duration; var M = null; var d = false; function y() { var P = b(".ws_prev"); var i = b(".ws_next"); try {
    if (B == 0) {
        P.css("display", "none");
    }
    else {
...
catch (O) { } } if (j.hasClass("hidecontrolls")) {
    y();
} if (j.hasClass("fullscreen")) {
    function g(P, O, i) { if (P.addEventListener) {
        P.addEventListener(O, i, false);
    }
    else {
        P.attachEvent("on" + O, i);
    } }
    function n(P, O, i) { if (P.removeEventListener) {
        P.removeEventListener(O, i);
    }
    else {
        P.detachEvent("on" + O, i);
    } }
    function J(Q, P) { if (!Q.length) {
        Q = [Q];
    } for (var R in P) {
    ...
    function C(Q) { if (h) {
        ...
        (function () { var R = b(".ws_shadow").css("background-image"); R = R.replace("url(", "").replace(")", "").replace(/\/$/, ""); b(".ws_shadow").css("background-image", "none").append(b("<img src=" + R + "></img>").css("width", "100%")); })();
    ...
    function u(i) { if (i.keyCode == 27) {
        H(true);
    } }
    b(document).on("webkitfullscreenchange mozfullscreenchange fullscreenchange", function () { d = !d; b(""); if (!d) {
        H(true);
    } });
    function H(O) { if (!O) {
